 ...
 * @LastEditors: mjh
 * @LastEditTime: 2023-09-22 13:59:12
 * @Description:
 */
...
export default defineConfig({
    base: isProduction ? '/data-visual-drag/' : '/',
    resolve: {
        dedupe: ['vue']
    },
    plugins: [
        ...
        federation({
            ...
            shared: ['vue', 'dayjs', 'echarts', 'fpi-tg-factor-tools', 'echarts-gl', 'lodash-es', 'axios']
        }),
    ],
    build: {
        target: 'esnext',
